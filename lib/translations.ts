  ...
  es: {
    ...
    projects: {
      ...
      items: {
        ...
        t4Tag: "CRM",
        t4Title: "CRM Parroquia",
        t4Desc: "Sistema personalizado para el control de contabilidad, diezmos y ventas diarias.",
      },
    },
    differentiators: {
      label: "Filosofía",
  ...
  en: {
    ...
    projects: {
      ...
      items: {
        ...
        t4Tag: "CRM",
        t4Title: "CRM Parroquia",
        t4Desc: "Custom system for tracking bookkeeping, tithing records, and daily sales.",
      },
    },
    differentiators: {
      label: "Philosophy",
