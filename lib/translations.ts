...
export const translations = {
  es: {
    ...
    projects: {
      ...
      items: {
        t1Tag: "WEB",
        t1Title: "Corporate Landing",
        t1Desc: "Diseño premium de alta conversión para marcas globales.",
        t2Tag: "CRM",
        t2Title: "Healthcare CRM",
        t2Desc: "Gestión avanzada de expedientes y citas médicas para clínicas.",
        t3Tag: "SAAS",
        t3Title: "Management SaaS",
        t3Desc: "Control administrativo, facturación y reportería avanzada.",
        t4Tag: "SAAS",
        t4Title: "E-learning Platform",
        t4Desc: "Plataforma de cursos virtuales y educación interactiva.",
      },
    },
    differentiators: {
      label: "Filosofía",
  ...
  en: {
    ...
    projects: {
      ...
      items: {
        t1Tag: "WEB",
        t1Title: "Corporate Landing",
        t1Desc: "High-converting premium design for global brands.",
        t2Tag: "CRM",
        t2Title: "Healthcare CRM",
        t2Desc: "Advanced records and appointment management systems for clinics.",
        t3Tag: "SAAS",
        t3Title: "Management SaaS",
        t3Desc: "Administrative control, billing, and advanced reporting dashboard.",
        t4Tag: "SAAS",
        t4Title: "E-learning Platform",
        t4Desc: "Custom virtual education and interactive video courses portal.",
      },
    },
    differentiators: {
      label: "Philosophy",
