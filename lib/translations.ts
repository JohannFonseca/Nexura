  ...
  es: {
    ...
    projects: {
      ...
      items: {
        ...
        t2Tag: "CRM / SAAS",
        t2Title: "Orbitt CRM",
        t2Desc: "Sistema SaaS de gestión comercial, embudo Kanban de ventas y automatizaciones con WhatsApp.",
        t3Tag: "SAAS",
    ...
    demos: {
      ...
      onplateTitle: "OnPlate",
      onplateDesc: "Plataforma de realidad aumentada para restaurantes. Visualiza el menú en 3D en tu mesa antes de pedir.",
      onplateCta: "Solicitar Demo",
      koraTitle: "Kora",
      koraDesc: "Sistema ERP completo para la gestión de tu empresa: inventarios, ventas, facturación y finanzas integradas.",
      koraCta: "Solicitar Demo",
      aiTitle: "Veló",
      aiDesc: "Asistente telefónico inteligente con voz IA entrenado para tomar reservas y atender clientes 24/7.",
      aiCta: "Solicitar Demo",
    },
    differentiators: {
      label: "Filosofía",
      ...
      items: {
        ...
        i4Label: "Infraestructura Cloud",
        i4Desc: "Servidores ultrarrápidos y alta disponibilidad garantizada 24/7 desde el primer día.",
    ...
    pricing: {
      ...
      starterFeatures: [
        ...
        "Alojamiento web y configuración incluidos",
        "SEO técnico esencial",
        "Lista en 2 a 5 días hábiles"
      ],
      starterCta: "Solicitar",
      proTitle: "Sitio Web Profesional",
      proFeatures: [
        "Sitio web multi-sección completo y personalizado",
        "Panel de administración para gestión de contenidos",
        "Catálogo digital de productos o servicios",
        "Base de datos integrada para formularios y clientes",
        "Optimización SEO avanzada y dominio incluido",
        "Listo en 5 a 8 días hábiles"
      ],
      proCta: "Empezar ahora",
      enterpriseTitle: "Sistemas para Locales & Negocios",
      enterprisePriceSuffix: "/mes*",
      enterpriseFeatures: [
        "Sistemas de Punto de Venta (POS), CRM o E-Commerce a la medida",
        "Control de inventario, ventas, comandas y clientes en tiempo real",
        "Automatización con WhatsApp e Inteligencia Artificial",
        "Integración con SINPE Móvil y pasarelas de pago",
        "Panel multi-usuario con roles y permisos de acceso",
        "Soporte continuo, actualizaciones e infraestructura",
        "*Precio base aprox., varía según requerimientos del sistema."
      ],
  ...
  en: {
    ...
    projects: {
      ...
      items: {
        ...
        t2Tag: "CRM / SAAS",
        t2Title: "Orbitt CRM",
        t2Desc: "SaaS sales management system, visual Kanban pipeline, and WhatsApp automations.",
        t3Tag: "SAAS",
    ...
    demos: {
      ...
      onplateTitle: "OnPlate",
      onplateDesc: "Augmented reality platform for restaurants. Preview 3D menu dishes right on your table before ordering.",
      onplateCta: "Request Demo",
      koraTitle: "Kora",
      koraDesc: "Complete all-in-one ERP system for business operations: inventory, sales, invoicing, and finance.",
      koraCta: "Request Demo",
      aiTitle: "Veló",
      aiDesc: "Intelligent phone assistant with voice AI trained to accept reservations and handle inquiries live 24/7.",
      aiCta: "Request Demo",
    },
    differentiators: {
      label: "Philosophy",
      ...
      items: {
        ...
        i4Label: "Cloud Infrastructure",
        i4Desc: "High-speed servers & 24/7 guaranteed uptime from day one.",
    ...
    pricing: {
      ...
      starterFeatures: [
        ...
        "High-speed hosting & setup included",
        "Essential technical SEO",
        "Ready in 2 to 5 business days"
      ],
      starterCta: "Get started",
      proTitle: "Professional Website",
      proFeatures: [
        "Full multi-section custom website",
        "Admin panel for content & catalog management",
        "Digital product or service catalog",
        "Integrated database for forms & client leads",
        "Advanced SEO optimization & domain included",
        "Ready in 5 to 8 business days"
      ],
      proCta: "Start now",
      enterpriseTitle: "Custom Systems for Local Business",
      enterprisePriceSuffix: "/mo*",
      enterpriseFeatures: [
        "Tailor-made POS, CRM, E-Commerce or Custom Business Platforms",
        "Real-time inventory, sales, kitchen tickets, and client tracking",
        "WhatsApp automation & Artificial Intelligence",
        "SINPE Móvil & local payment gateway integrations",
        "Multi-user admin panel with granular permissions",
        "Ongoing support, updates & edge infrastructure",
        "*Approximate base price, varies by system scope."
      ],
    ...
    about: {
      ...
      row1Val: "Costa Rica",
      row2Label: "Focus",
      row2Val: "Performance & Reliability",
      row3Label: "Model",
      row3Val: "Custom + SaaS",
      row4Label: "Contact",
